...
public class EmployeeController {
	...
	@PostMapping("/add")
	public ResponseEntity<Employee> createOrUpdateEmployee(@RequestBody Employee employee) throws DataNotFoundException{
		Employee updateEmployee = service.createOrUpdate(employee);
	...
	@PutMapping("/update")
	public ResponseEntity<Employee> UpdateEmployee(@Validated @RequestBody Employee employee) throws DataNotFoundException{
		Employee updateEmployee = service.createOrUpdate(employee);
		ResponseEntity<Employee> response = new ResponseEntity<Employee>(updateEmployee,new HttpHeaders(),HttpStatus.OK);
		System.out.println(response);
		return response;
